define("tlSyncDataStore", ["require", "exports"], function (require, exports) {
        ...
        (function (Sync) {
            ...
            var SyncDataStoreService = (function () {
                ...
                SyncDataStoreService.prototype.initialize = function (webApiPath, syncTypes, versionNumber) {
                    ...
                    exports.SyncDataStore.initialize(webApiPath, syncTypes, versionNumber, function () { return deferred.resolve(); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.register = function (cookie) {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.register(cookie, function () { return deferred.resolve(); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.resetDb = function () {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.resetDb(function () { return deferred.resolve(); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.unRegister = function () {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.unRegister(function () { return deferred.resolve(); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.requestSync = function (reason, force) {
                    ...
                    var sync = function () {
                        exports.SyncDataStore.requestSync(function () { return deferred.resolve(); }, function (err) { return deferred.reject(err); });
                        this.timeout = null;
                    };
                    if (force === true) {
                        sync();
                ...
                SyncDataStoreService.prototype.getLastUpdateTimestamp = function (collectionName) {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.getLastUpdateTimestamp(collectionName, function (timestamp) { return deferred.resolve(timestamp); }, function () { return deferred.reject(); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.isSyncing = function () {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.isSyncing(function (isSyncing) { return deferred.resolve(isSyncing === "true"); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.listen = function (typeName, success, error) {
                    exports.SyncDataStore.listen(typeName, success, error);
                };
                SyncDataStoreService.prototype.onError = function (collectionName, success, error) {
                    exports.SyncDataStore.onError(collectionName, success, error);
                };
                SyncDataStoreService.prototype.onSyncStateChanged = function (success, error) {
                    exports.SyncDataStore.onSyncStateChanged(success, error);
                };
                SyncDataStoreService.prototype.createReport = function (errorDescription) {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.createReport(errorDescription, function () { return deferred.resolve(); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.isAuthenticated = function () {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.isAuthenticated(function (isAuthenticated) { return deferred.resolve(isAuthenticated === "true"); }, function (err) { return deferred.reject(err); });
                    return deferred.promise;
                };
                SyncDataStoreService.prototype.lockSync = function () {
                    var _this = this;
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.lockSync(function (lockId) { return deferred.resolve({
                        lockId: lockId,
                        unlock: function () {
                ...
                SyncDataStoreService.prototype.unlockSync = function (lockId) {
                    var deferred = this.$q.defer();
                    exports.SyncDataStore.unlockSync(lockId, function () { return deferred.resolve(); }, function () { return deferred.reject(); });
                    return deferred.promise;
                };
            ...
            if (typeof exports.SyncDataStore !== "undefined") {
    ...
    })(Triarc = exports.Triarc || (exports.Triarc = {}));
});
